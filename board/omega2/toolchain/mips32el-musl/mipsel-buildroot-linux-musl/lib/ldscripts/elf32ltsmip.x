...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/mipsel-buildroot-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{

...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/bin',
    'BINLIBDEST': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13',
    'BLDLIBRARY': '-L. -lpython3.13',
    'BLDSHARED': '/usr/bin/gcc -pthread -shared -L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -O2 -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    ...
    'CONFIGURE_CFLAGS': '-O2 -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    ...
    'CONFIGURE_CPPFLAGS': '-I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'CONFIGURE_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1' '--sysconfdir=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/etc' '--localstatedir=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/var' '--enable-shared' '--disable-static' '--disable-gtk-doc' '--disable-gtk-doc-html' '--disable-doc' '--disable-docs' '--disable-documentation' '--disable-debug' '--with-xmlto=no' '--with-fop=no' '--disable-nls' '--disable-dependency-tracking' '--without-ensurepip' '--without-cxx-main' '--disable-sqlite3' '--disable-tk' '--with-expat=system' '--disable-test-modules' '--disable-idle3' '--disable-curses' 'PKG_CONFIG=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/bin/pkg-config' 'PKG_CONFIG_LIBDIR=/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/pkgconfig:/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/share/pkgconfig' 'CC=/usr/bin/gcc' 'CFLAGS=-O2 -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include' 'LDFLAGS=-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags' 'CPPFLAGS=-I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include' 'CPP=/usr/bin/cpp'",
    'CONFINCLUDEDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'CONFINCLUDEPY': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include/python3.13',
    'COREPYTHONPATH': '',
    ...
    'CPPFLAGS': '-I. -I./Include -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'CXX': '/usr/bin/g++ -pthread',
    'DESTDIRS': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1 /builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib /builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13 /builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13/lib-dynload',
    'DESTLIB': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLUDEDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'INCLUDEPY': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/usr/bin/g++ -pthread -shared -L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/usr/bin/gcc -pthread -shared -L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13',
    'LIBDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/pkgconfig',
    'LIBPL': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': '/bin/mkdir -p',
    ...
    'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'MODULE_BINASCII_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -lz',
    ...
    'MODULE_ZLIB_CFLAGS': '-I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'MODULE_ZLIB_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -lz',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'MODULE__CTYPES_DEPS': './Modules/_ctypes/ctypes.h',
    'MODULE__CTYPES_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/../lib -lffi -ldl',
    ...
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -O2 -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    ...
    'PY_CORE_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'PY_CPPFLAGS': '-I. -I./Include -I/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 1,
    'PY_LDFLAGS': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,-rpath,/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib -Wl,--enable-new-dtags',
    ...
    'SCRIPTDIR': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1',
    'WASM_STDLIB': './builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'datarootdir': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1/share',
    'exec_prefix': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1',
    'prefix': '/builds/buildroot.org/toolchains-builder/build/mips32el--musl--stable-2025.08-1',
    'srcdir': '.',
}

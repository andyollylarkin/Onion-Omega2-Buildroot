...
enum opt_code
{
  ...
  OPT_Wpragmas = 672,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 673,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 674,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 675,                       /* -Wprotocol */
  OPT_Wpsabi = 676,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 677,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 678,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 679,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 680,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 681,                /* -Wredundant-decls */
  OPT_Wredundant_move = 682,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 683,                 /* -Wredundant-tags */
  OPT_Wregister = 684,                       /* -Wregister */
  OPT_Wreorder = 685,                        /* -Wreorder */
  OPT_Wrestrict = 686,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 687,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 688,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 689,           /* -Wscalar-storage-order */
  OPT_Wselector = 690,                       /* -Wselector */
  OPT_Wsequence_point = 691,                 /* -Wsequence-point */
  OPT_Wshadow = 692,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 693, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 694,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 695, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 696,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 697, */            /* -Wshadow=global */
  OPT_Wshadow_local = 698,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 699,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 700,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 701,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 702, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 703,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 704,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 705,                /* -Wsign-conversion */
  OPT_Wsign_promo = 706,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 707,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 708,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 709,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 710,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 711,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 712,                    /* -Wspeculative */
  OPT_Wstack_protector = 713,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 714,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 715,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 716,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 717,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 718,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 719,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 720,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 721,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 722,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 723, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 724,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 725,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 726,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 727,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 728,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 729,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 730,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 731,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 732,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 733,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 734,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 735,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 736,               /* -Wsuggest-override */
  OPT_Wsurprising = 737,                     /* -Wsurprising */
  OPT_Wswitch = 738,                         /* -Wswitch */
  OPT_Wswitch_bool = 739,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 740,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 741,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 742,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 743,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 744,                      /* -Wsync-nand */
  OPT_Wsynth = 745,                          /* -Wsynth */
  OPT_Wsystem_headers = 746,                 /* -Wsystem-headers */
  OPT_Wtabs = 747,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 748,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 749,           /* -Wtautological-compare */
  OPT_Wtemplates = 750,                      /* -Wtemplates */
  OPT_Wterminate = 751,                      /* -Wterminate */
  OPT_Wtraditional = 752,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 753,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 754,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 755,                      /* -Wtrigraphs */
  OPT_Wtsan = 756,                           /* -Wtsan */
  OPT_Wtype_limits = 757,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 758,            /* -Wundeclared-selector */
  OPT_Wundef = 759,                          /* -Wundef */
  OPT_Wundefined_do_loop = 760,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 761,                      /* -Wunderflow */
  OPT_Wuninitialized = 762,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 763,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 764, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 765, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 766,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 767,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 768,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 769,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 770, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 771,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 772,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 773,                /* -Wunused-function */
  OPT_Wunused_label = 774,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 775,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 776,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 777,               /* -Wunused-parameter */
  OPT_Wunused_result = 778,                  /* -Wunused-result */
  OPT_Wunused_value = 779,                   /* -Wunused-value */
  OPT_Wunused_variable = 780,                /* -Wunused-variable */
  OPT_Wuse_without_only = 781,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 782,                   /* -Wuseless-cast */
  OPT_Wvarargs = 783,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 784,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 785,   /* -Wvector-operation-performance */
  OPT_Wvexing_parse = 786,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 787,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 788,            /* -Wvirtual-move-assign */
  OPT_Wvla = 789,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 790,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 791,                  /* -Wvla-parameter */
  OPT_Wvolatile = 792,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 793,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 794,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 795,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 796,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 797,                       /* -Wzerotrip */
  OPT_X = 798,                               /* -X */
  OPT_Xassembler = 799,                      /* -Xassembler */
  OPT_Xf = 800,                              /* -Xf */
  OPT_Xlinker = 801,                         /* -Xlinker */
  OPT_Xpreprocessor = 802,                   /* -Xpreprocessor */
  OPT_Z = 803,                               /* -Z */
  OPT_ansi = 804,                            /* -ansi */
  OPT_aux_info = 805,                        /* -aux-info */
  /* OPT_aux_info_ = 806, */                 /* -aux-info= */
  OPT_c = 807,                               /* -c */
  OPT_callgraph = 808,                       /* -callgraph */
  OPT_coverage = 809,                        /* -coverage */
  OPT_cpp = 810,                             /* -cpp */
  OPT_cpp_ = 811,                            /* -cpp= */
  OPT_d = 812,                               /* -d */
  OPT_debuglib_ = 813,                       /* -debuglib= */
  OPT_defaultlib_ = 814,                     /* -defaultlib= */
  OPT_defined_only = 815,                    /* -defined-only */
  OPT_demangle = 816,                        /* -demangle */
  OPT_dstartfiles = 817,                     /* -dstartfiles */
  OPT_dump_body_ = 818,                      /* -dump-body= */
  OPT_dump_level_ = 819,                     /* -dump-level= */
  OPT_dumpbase = 820,                        /* -dumpbase */
  OPT_dumpbase_ext = 821,                    /* -dumpbase-ext */
  OPT_dumpdir = 822,                         /* -dumpdir */
  OPT_dumpfullversion = 823,                 /* -dumpfullversion */
  OPT_dumpmachine = 824,                     /* -dumpmachine */
  OPT_dumpspecs = 825,                       /* -dumpspecs */
  OPT_dumpversion = 826,                     /* -dumpversion */
  OPT_e = 827,                               /* -e */
  OPT_export_dynamic = 828,                  /* -export-dynamic */
  OPT_fPIC = 829,                            /* -fPIC */
  OPT_fPIE = 830,                            /* -fPIE */
  OPT_fRTS_ = 831,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 832,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 833,                   /* -fabi-version= */
  OPT_faccess_control = 834,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 835,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 836,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 837,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 838,                  /* -falign-commons */
  OPT_falign_functions = 839,                /* -falign-functions */
  OPT_falign_functions_ = 840,               /* -falign-functions= */
  OPT_falign_jumps = 841,                    /* -falign-jumps */
  OPT_falign_jumps_ = 842,                   /* -falign-jumps= */
  OPT_falign_labels = 843,                   /* -falign-labels */
  OPT_falign_labels_ = 844,                  /* -falign-labels= */
  OPT_falign_loops = 845,                    /* -falign-loops */
  OPT_falign_loops_ = 846,                   /* -falign-loops= */
  /* OPT_faligned_new = 847, */              /* -faligned-new */
  OPT_faligned_new_ = 848,                   /* -faligned-new= */
  OPT_fall_instantiations = 849,             /* -fall-instantiations */
  OPT_fall_intrinsics = 850,                 /* -fall-intrinsics */
  OPT_fall_virtual = 851,                    /* -fall-virtual */
  OPT_fallocation_dce = 852,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 853,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 854,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 855,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 856,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 857,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 858,         /* -falt-external-templates */
  ...
  OPT_list = 1678,                           /* -list */
  OPT_mabi_ = 1679,                          /* -mabi= */
  OPT_mabicalls = 1680,                      /* -mabicalls */
  OPT_mabs_ = 1681,                          /* -mabs= */
  OPT_mandroid = 1682,                       /* -mandroid */
  OPT_march_ = 1683,                         /* -march= */
  OPT_mbionic = 1684,                        /* -mbionic */
  OPT_mbranch_cost_ = 1685,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1686,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1687,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1688,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1689,             /* -mcompact-branches= */
  OPT_mcrc = 1690,                           /* -mcrc */
  OPT_mdebug = 1691,                         /* -mdebug */
  OPT_mdebugd = 1692,                        /* -mdebugd */
  OPT_mdivide_breaks = 1693,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1694,                  /* -mdivide-traps */
  OPT_mdmx = 1695,                           /* -mdmx */
  OPT_mdouble_float = 1696,                  /* -mdouble-float */
  OPT_mdsp = 1697,                           /* -mdsp */
  OPT_mdspr2 = 1698,                         /* -mdspr2 */
  OPT_meb = 1699,                            /* -meb */
  OPT_mel = 1700,                            /* -mel */
  OPT_membedded_data = 1701,                 /* -membedded-data */
  OPT_meva = 1702,                           /* -meva */
  OPT_mexplicit_relocs = 1703,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1704,                  /* -mextern-sdata */
  OPT_mfix_24k = 1705,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1706,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1707,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1708,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1709,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1710,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1711,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1712,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1713,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1714,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1715,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1716,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1717,                 /* -mfp-exceptions */
  OPT_mfp32 = 1718,                          /* -mfp32 */
  OPT_mfp64 = 1719,                          /* -mfp64 */
  OPT_mfpxx = 1720,                          /* -mfpxx */
  OPT_mframe_header_opt = 1721,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1722, */              /* -mfused-madd */
  OPT_mginv = 1723,                          /* -mginv */
  OPT_mglibc = 1724,                         /* -mglibc */
  OPT_mgp32 = 1725,                          /* -mgp32 */
  OPT_mgp64 = 1726,                          /* -mgp64 */
  OPT_mgpopt = 1727,                         /* -mgpopt */
  OPT_mhard_float = 1728,                    /* -mhard-float */
  OPT_mimadd = 1729,                         /* -mimadd */
  OPT_minterlink_compressed = 1730,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1731,              /* -minterlink-mips16 */
  OPT_mips = 1732,                           /* -mips */
  OPT_mips16 = 1733,                         /* -mips16 */
  OPT_mips3d = 1734,                         /* -mips3d */
  OPT_mllsc = 1735,                          /* -mllsc */
  OPT_mload_store_pairs = 1736,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1737,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1738,                    /* -mlong-calls */
  OPT_mlong32 = 1739,                        /* -mlong32 */
  OPT_mlong64 = 1740,                        /* -mlong64 */
  OPT_mloongson_ext = 1741,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1742,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1743,                  /* -mloongson-mmi */
  OPT_mlra = 1744,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1745,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1746,                           /* -mmad */
  OPT_mmadd4 = 1747,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1748,             /* -mmcount-ra-address */
  OPT_mmcu = 1749,                           /* -mmcu */
  OPT_mmemcpy = 1750,                        /* -mmemcpy */
  OPT_mmicromips = 1751,                     /* -mmicromips */
  OPT_mmsa = 1752,                           /* -mmsa */
  OPT_mmt = 1753,                            /* -mmt */
  OPT_mmusl = 1754,                          /* -mmusl */
  OPT_mnan_ = 1755,                          /* -mnan= */
  OPT_mno_float = 1756,                      /* -mno-float */
  OPT_mno_flush_func = 1757,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1758,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1759,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1760,                     /* -mno-mips3d */
  OPT_modd_spreg = 1761,                     /* -modd-spreg */
  OPT_mpaired_single = 1762,                 /* -mpaired-single */
  OPT_mplt = 1763,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1764,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1765,               /* -mrelax-pic-calls */
  OPT_mshared = 1766,                        /* -mshared */
  OPT_msingle_float = 1767,                  /* -msingle-float */
  OPT_msmartmips = 1768,                     /* -msmartmips */
  OPT_msoft_float = 1769,                    /* -msoft-float */
  OPT_msplit_addresses = 1770,               /* -msplit-addresses */
  OPT_msym32 = 1771,                         /* -msym32 */
  OPT_msynci = 1772,                         /* -msynci */
  OPT_mtune_ = 1773,                         /* -mtune= */
  OPT_muclibc = 1774,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1775,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1776,                          /* -mvirt */
  OPT_mvr4130_align = 1777,                  /* -mvr4130-align */
  OPT_mxgot = 1778,                          /* -mxgot */
  OPT_mxpa = 1779,                           /* -mxpa */
  OPT_n = 1780,                              /* -n */
  ...
  OPT_profile = 1816,                        /* -profile */
  OPT_pthread = 1817,                        /* -pthread */
  OPT_quiet = 1818,                          /* -quiet */
  OPT_r = 1819,                              /* -r */
  OPT_rdynamic = 1820,                       /* -rdynamic */
  OPT_remap = 1821,                          /* -remap */
  OPT_reverse_sort = 1822,                   /* -reverse-sort */
  OPT_s = 1823,                              /* -s */
  OPT_save_temps = 1824,                     /* -save-temps */
  OPT_save_temps_ = 1825,                    /* -save-temps= */
  OPT_shared = 1826,                         /* -shared */
  OPT_shared_libgcc = 1827,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1828,               /* -shared-libphobos */
  OPT_size_sort = 1829,                      /* -size-sort */
  /* OPT_specs = 1830, */                    /* -specs */
  OPT_specs_ = 1831,                         /* -specs= */
  OPT_static = 1832,                         /* -static */
  OPT_static_libasan = 1833,                 /* -static-libasan */
  OPT_static_libgcc = 1834,                  /* -static-libgcc */
  OPT_static_libgfortran = 1835,             /* -static-libgfortran */
  OPT_static_libgo = 1836,                   /* -static-libgo */
  OPT_static_libhwasan = 1837,               /* -static-libhwasan */
  OPT_static_liblsan = 1838,                 /* -static-liblsan */
  OPT_static_libmpx = 1839,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1840,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1841,               /* -static-libphobos */
  OPT_static_libstdc__ = 1842,               /* -static-libstdc++ */
  OPT_static_libtsan = 1843,                 /* -static-libtsan */
  OPT_static_libubsan = 1844,                /* -static-libubsan */
  OPT_static_pie = 1845,                     /* -static-pie */
  /* OPT_std_c__03 = 1846, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1847, */                /* -std=c++0x */
  OPT_std_c__11 = 1848,                      /* -std=c++11 */
  OPT_std_c__14 = 1849,                      /* -std=c++14 */
  OPT_std_c__17 = 1850,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1851, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1852, */                /* -std=c++1z */
  OPT_std_c__20 = 1853,                      /* -std=c++20 */
  OPT_std_c__23 = 1854,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1855, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1856, */                /* -std=c++2b */
  ...
  OPT_std_gnu__23 = 1881,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1882, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1883, */              /* -std=gnu++2b */
  ...
  OPT_stdlib_ = 1902,                        /* -stdlib= */
  OPT_symbol_ = 1903,                        /* -symbol= */
  OPT_symbolic = 1904,                       /* -symbolic */
  OPT_t = 1905,                              /* -t */
  OPT_time = 1906,                           /* -time */
  OPT_time_ = 1907,                          /* -time= */
  OPT_tno_android_cc = 1908,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1909,                 /* -tno-android-ld */

...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/build-ncs/x-tools/mipsel-unknown-linux-musl/mipsel-unknown-linux-musl/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/build-ncs/x-tools/mipsel-unknown-linux-musl/mipsel-unknown-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
